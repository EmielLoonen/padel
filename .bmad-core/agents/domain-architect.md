...
IDE-FILE-RESOLUTION:
  ...
  - Example: BP-BA-1-EBP_Aligns_with_Industry_standards_and_Reference_architectures.md → .bmad-core/principles/BP-BA-1-EBP_Aligns_with_Industry_standards_and_Reference_architectures.md
