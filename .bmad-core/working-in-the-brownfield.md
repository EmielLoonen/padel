...
> - If working in the web: use `npx backbase-bmad flatten` to flatten your project into a single file, then upload that file to your web agent.
...
2. **Generate a 'flattened' single file of your entire codebase** run: ```npx backbase-bmad flatten```
